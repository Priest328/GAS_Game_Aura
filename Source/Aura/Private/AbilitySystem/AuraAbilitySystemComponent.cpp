...
void UAuraAbilitySystemComponent::ForEachAbility(const FForEachAbility& ForEachAbilityDelegate)
{
	...
	{
		if (!ForEachAbilityDelegate.ExecuteIfBound(Spec))
		{
...
FGameplayTag UAuraAbilitySystemComponent::GetAbilityTagFromSpec(const FGameplayAbilitySpec& AbilitySpec)
{
	...
	{
		for (FGameplayTag GameplayTag : AbilitySpec.Ability.Get()->GetAssetTags())
		{
...
void UAuraAbilitySystemComponent::UpdateAbilityStatuses(int32 Level)
{
	...
	for (const FAuraAbilityInfo& Info : AbilityInfo->AbilitiesInfo)
	{
