...
void AAuraPlayerController::ShowDamageNumber_Implementation(float DamageAmount, bool bBlockedHit, bool bCriticalHit,
                                                            ACharacter* TargetCharacter)
{
	if (!IsValid(TargetCharacter) && !IsValid(DamageTextComp) && IsLocalController())
	{
		return;
	}

	UDamageTextComponent* DamageText = NewObject<UDamageTextComponent>(TargetCharacter, DamageTextComp);
